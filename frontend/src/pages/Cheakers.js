...
function Cheakers() {
    const { unityProvider, isLoaded, loadingProgression, requestFullscreen } = useUnityContext({
        loaderUrl: "cheakers/checker.loader.js",
        dataUrl: "cheakers/checker.data",
        frameworkUrl: "cheakers/checker.framework.js",
        codeUrl: "cheakers/checker.wasm",
